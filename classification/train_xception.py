...
# 1. Load the data
train_df = pd.read_csv("D:/Deepfake_Detection_project/data_preprocessing/output_split/train_labels_mtcnn.csv")
val_df = pd.read_csv("D:/Deepfake_Detection_project/data_preprocessing/output_split/val_labels_mtcnn.csv")
test_df = pd.read_csv("D:/Deepfake_Detection_project/data_preprocessing/output_split/test_labels_mtcnn.csv")
...
# Apply class weighting for the real:fake imbalance (1:3)
class_weight = {0: 3.0, 1: 1.0}  # 0: real, 1: fake

# Train the model and display detailed metrics per epoch
history = model.fit(
    train_generator,
...
model.save("D:/Deepfake_Detection_project/classification/models/deepfake_model_mtcnn2.h5")
...
plt.ylabel("Actual")
plt.savefig("D:/Deepfake_Detection_project/classification/output/confusion_matrix.png")
plt.show()
...
plt.savefig("D:/Deepfake_Detection_project/classification/output/training_plots.png")
plt.show()