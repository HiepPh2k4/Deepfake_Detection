...
if __name__ == '__main__':
    ...
    model, metrics, _, _, _, _ = train_and_evaluate(
        ...
        model_name="GhostNet", num_epochs=NUM_EPOCHS, device=DEVICE, save_dir=OUTPUT_PATH, patience=PATIENCE
    )

    # Save final model
    os.makedirs(MODEL_PATH, exist_ok=True)
    torch.save(model.state_dict(), os.path.join(MODEL_PATH, "ghostnet_deepfake.pth"))
