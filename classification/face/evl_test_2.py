...
from classification.face.Implementation.xception_optimized.advanced_xception import create_optimized_model
...
def evaluate_model(model, test_loader, criterion):
    ...
    with torch.no_grad():
        for images, targets, img_paths in tqdm(test_loader, desc="Inference"):
...
def plot_results(metrics, test_labels, test_probs, output_path):
    ...
    sns.heatmap(metrics["cm"], annot=True, fmt="d", cmap="Blues", xticklabels=['Real', 'Fake'], yticklabels=['Real', 'Fake'])
