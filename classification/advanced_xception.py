...
class SpatialAttention(nn.Module):
    """Spatial attention focusing on important regions."""
...
class OptimizedXceptionNet(nn.Module):
    """Optimized Xception for deepfake detection."""
    def __init__(self, num_classes=1, dropout_rate=0.5):
        ...
        self.feat_channels = [256, 728, 2048]
        self.attention_modules = nn.ModuleList([
            DualAttentionModule(ch, reduction=16) for ch in self.feat_channels
        ])
