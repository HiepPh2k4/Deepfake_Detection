...
BATCH_SIZE = 32
NUM_WORKERS = 8
PRETRAIN_EPOCHS = 3  # Tăng từ 3 lên 5
FINETUNE_EPOCHS = 15
LEARNING_RATE = 2e-4  # Đồng nhất với lần trước
WEIGHT_DECAY = 1e-4
POS_WEIGHT = 0.25
PATIENCE = 3  # Giảm từ 5 xuống 3
...
def main():
    ...
    for epoch in range(PRETRAIN_EPOCHS):
        ...
        print(
            f"Epoch {epoch + 1}/{PRETRAIN_EPOCHS}: Train Loss: {train_loss:.4f}, Train Accuracy: {train_metrics['accuracy']:.4f}, "
    ...
    # Reinitialize optimizer for all parameters
