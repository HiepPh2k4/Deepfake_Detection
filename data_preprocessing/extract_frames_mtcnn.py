...
# Danh sách thư mục cần bỏ qua trong manipulated_sequences
excluded_folders = ["Face2Face", "DeepFakeDetection"]
...
def process_videos(video_dir, label, output_folder):
    ...
    # Lấy tên thư mục nguồn (Deepfakes, FaceShifter, v.v.)
...
# Hàm duyệt qua tất cả các thư mục giả, bỏ qua Face2Face và DeepfakeDetection
...
if __name__ == "__main__":
    ...
    print("Hoàn tất trích xuất khuôn mặt và tính toán metrics từ các thư mục video giả!")